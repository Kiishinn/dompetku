    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              'Tempelkan teks data cadangan JSON Anda di bawah ini:',
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (jsonText.isNotEmpty) {
                final success = await StorageService.instance
                    .restoreFromBackupJson(jsonText);
                if (success) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        "Data cadangan JSON berhasil dipulihkan 100%!",
                      ),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        "Format teks JSON tidak valid. Harap periksa kembali.",
                      ),
            ...
            children: [
              ...
              TextField(
                ...
                onChanged: (text) {
                  ...
                  initialNotifier.value = trimmed.isNotEmpty
                      ...
                      onPressed: () {
                        if (nameController.text.trim().isNotEmpty) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Profil berhasil diperbarui & tersimpan!',
                              ),
                              backgroundColor: AppTheme.incomeGreen,
                              behavior: SnackBarBehavior.floating,
                            ),
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            ListTile(
              leading: Icon(Icons.table_chart, color: AppTheme.incomeGreen),
              title: Text(
                'Format CSV (Excel)',
              ...
              onTap: () async {
                Navigator.pop(ctx);
                await ExportService.instance.exportCsvReport(
            ...
            SizedBox(height: 10),
            ListTile(
              leading: Icon(Icons.picture_as_pdf, color: AppTheme.expenseRed),
              title: Text(
                'Format PDF (Ringkasan Resmi)',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14),
              ),
              subtitle: Text(
                'Format cetak resmi laporan arus kas bulanan',
                style: TextStyle(fontSize: 11),
              ),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(12),
                          ...
                          ? Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 4),
                                  Text(
                                    "Tekan '+ Tambah Tagihan' di atas untuk mendaftarkan tagihan bulanan.",
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: AppTheme.textSecondary,
                                    ),
                                              ...
                                              IconButton(
                                                ...
                                                onPressed: () {
                                                  ...
                                                  ScaffoldMessenger.of(
                                                    ...
                                                    SnackBar(
                                                      content: Text(
                                                        "Tagihan '${bill.title}' telah dihapus",
                                                      ),
                                                      backgroundColor:
                                                          AppTheme.expenseRed,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              spacing: 12,
                              runSpacing: 12,
                              children: List.generate(availableIcons.length, (
                                idx,
                              ) {
                        ...
                        onPressed: () {
                          ...
                          if (title.isNotEmpty && amount > 0) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  "Tagihan '$title' berhasil ditambahkan!",
                                ),
                                backgroundColor: AppTheme.incomeGreen,
                                behavior: SnackBarBehavior.floating,
                              ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: AppTheme.incomeGreen.withOpacity(
                                      0.2,
                                    ),
                                    borderRadius: BorderRadius.circular(20),
                                    border: Border.all(
                              ...
                              Row(
                                children: [
                                  Icon(
                                    ...
                                    color: appState.financialHealthScore > 0
                                        ? appState.financialHealthColor
                                        : Colors.white70,
                                    size: 18,
                                  ),
                                  SizedBox(width: 8),
                  ...
                  child: Column(
                    children: [
                      _buildMenuItem(
                        ...
                        onTap: () {
                          AturAnggaranSheet.show(
                            ...
                            onSaveBudget:
                                (catName, limit, warningPercent, isNotif) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                      ...
                      _buildMenuItem(
                        ...
                        onTap: () {
                          PilihKategoriSheet.show(context, isManageOnly: true);
                        },
                      ),
                      Divider(
                        height: 1,
                      ...
                      _buildMenuItem(
                        ...
                        subtitle:
                            'Kelola jadwal otomatis (Gaji, Tagihan & Langganan)',
                        onTap: () {
                              ...
                              onChanged: (val) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      val
                                          ? "Notifikasi & Peringatan Diaktifkan"
                                          : "Notifikasi Dinonaktifkan secara total",
                                    ),
                                    backgroundColor: val
                                        ? AppTheme.primary
                                        : AppTheme.expenseRed,
                        ...
                        onTap: () {
                          showDialog(
                            ...
                            builder: (confirmCtx) => AlertDialog(
                              ...
                              content: Text(
                                "Apakah Anda yakin ingin menghapus seluruh riwayat transaksi, mereset saldo dompet, dan mengembalikan profil ke awal? Tindakan ini tidak dapat dibatalkan.",
                              ),
                              actions: [
                                TextButton(
                                ...
                                ElevatedButton(
                                  onPressed: () {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          "Seluruh data & profil telah di-reset dari awal!",
                                        ),
                                        backgroundColor: AppTheme.expenseRed,
                                        behavior: SnackBarBehavior.floating,
                                      ),
